                          ...
                          return Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: comments[index]?.user?.avatar != null
                                    ? ClipOval(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              height: SizeConfig.kDefaultSize *
                                                  0.04,
                                            ),
                                            Text(
                                              comments[index].text,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          if (comments[index].replies[replyIndex].user != null &&
                                                                              comments[index].replies[replyIndex].user.firstName != null &&
                                                                              comments[index].replies[replyIndex].user.lastName != null)
                                                                            Text(
                                                                              comments[index].replies[replyIndex].user.firstName + " " + comments[index].replies[replyIndex].user.lastName,
                                                                              style: labelTextStyle.copyWith(
