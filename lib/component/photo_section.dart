          ...
          child: Column(
            ...
            children: [
              ...
              FutureBuilder<Timeline>(
                future: _userProvider.getPhotoPosts(userId: widget.userId),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    if (snapshot.data.posts.data != null &&
                        snapshot.data.posts.data.length > 0) {
                      return Wrap(
                        children: List.generate(
                          snapshot.data.posts.data.length > 8
                              ? snapshot.data.posts.data.sublist(0, 7).length
